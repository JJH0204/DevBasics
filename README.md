...
## 학습 주제
- C/C++언어 고급: 포인터 메모리 관리<br/>파일 입출력<br/>구조체와 공용체를 포함한 고급 문법 학습
- 자료구조 기초/심화: 리스트<br/>스택<br/>큐<br/>트리<br/>그래프 등 자료구조를 실제 구현 및 문제에 적용하는 방법 학습
- 알고리즘 기초: 정렬<br/>검색<br/>기본적인 알고리즘 문제 해결 방법 학습
- 객체지향 프로그래밍 기초: 객체지향 프로그래밍의 원리를 이해하기 위한 기초를 학습


## 필수 조건
- 각 개념을 실습하며<br/>작은 프로젝트 또는 알고리즘을 해결하며 이론과 실제를 연결합니다.
...
| Search                            |       | [Search.md](markdown/DataStructure/Search.md)                                                    |[mainSequentialSearch.c](source/DSNA/non-Linear/mainSequentialSearch.c) <br/>[mainIndexSequentialSearch.c](source/DSNA/non-Linear/mainIndexSequentialSearch.c)
